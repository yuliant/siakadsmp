...
class M_model extends CI_Model {
	...
	function getKelas(){
		$sql ="SELECT k.id_kelas, k.access_nilai,k.nama_kelas, k.sub_kelas, COUNT(s.id_siswa) as total_siswa FROM tbl_kelas k LEFT JOIN tb_siswa s ON k.id_kelas = s.id_kelas GROUP BY k.id_kelas ";
		return $this->db->query($sql)->result();
	}
