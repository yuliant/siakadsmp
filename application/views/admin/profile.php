          ...
          <table class="table table-bordered" width="100%" cellspacing="0">
            <thead>
              ...
              <tr>
                <th>Password</th>
                <td>
                  <a href="<?php echo site_url('a/change/') . encrypt_url($data->id_guru) ?>" class="btn btn-primary btn-icon-split btn-sm">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="<?php echo site_url('admin/changeimage/') . encrypt_url($data->id_guru) ?>" class="btn btn-primary btn-icon-split btn-sm mt-2">
                    <span class="icon text-white-50">
                      <i class="fas fa-edit"></i>
                    </span>
