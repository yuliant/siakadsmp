    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <div class="table-responsive">
          ...
          <?php echo form_open_multipart('administrator/admin/editSiswaProses/' . $siswa->id_siswa . '/' . $nama_kelas); ?>
          <div style="padding-left: 20px; padding-right: 20px; margin-bottom: 50px">
            ...
            <div class="col-sm-10 mb-4">
              <div class="row">
                <div class="col-sm-3">
                  <img src="<?php echo base_url('assets/img/profile/') . $siswa->image; ?>" class="img-thumbnail">
                </div>
                <div class="col-sm-9">
