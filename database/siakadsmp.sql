...
(5, 177777, '123', 'BUDI SANTOSO', 'ISLAM', 'LAKI LAKI', 'SIDOARJO', '2020-07-20', 'S1', 'GURU MAPEL', 'KENDAL', 1, '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'logo_mitrakarya_pompa_indonesia1.png');
...
(16, 21, 1, 1, 'GENAP', NULL, NULL, NULL, NULL, NULL, NULL, 1, 'AKTIF', '2020/2021'),
(17, 22, 1, 1, 'GENAP', NULL, NULL, NULL, NULL, NULL, NULL, 1, 'AKTIF', '2020/2021');
...
(9, 20010010109, 'MOH. ABDUL GHONI', 'LAKI LAKI', 'SIDOARJO', '2004-07-01', 'M. BACKTIAR', 'MAESAROH', '081234578922', 'SWASTA', 'GURU', 'ISLAM', 'JL. JAYA RAHARJO NO 8', 14, 'AKTIF', 'b54a8bdc4fe3233a96e05815c4d11c1b958298de', 'default.jpg'),
...
(23, 12121212, 'AMAR KUMAL', 'LAKI LAKI', 'SIDOARJO', '2020-07-16', 'HADI', 'RURI CHAN', '089111222333', 'MANDOR', 'IBU RUMAH TANGGA', 'ISLAM', 'KENDAL', 13, 'ALUMNI', 'cc4723995ce819915e734147a77850427a9e95f9', 'dragon_chan.jpg'),
(24, 123456789, 'MASRIZAL', 'LAKI LAKI', 'SIDOARJO', '2020-07-31', 'ARI', 'SRI', '08912345678', 'MANDOR', 'IBU RUMAH TANGGA', 'ISLAM', 'KENDAL', 1, 'AKTIF', 'f7c3bc1d808e04732adf679965ccc34ca7ae3441', 'logo_mitrakarya_pompa_indonesia.png');
...
--
ALTER TABLE `tb_guru`
  MODIFY `id_guru` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tb_nilai`
  MODIFY `id_nilai` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `tb_siswa`
--
ALTER TABLE `tb_siswa`
  MODIFY `id_siswa` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
COMMIT;
